...
console.log(Math.random(0, 1)); // Un nombre aléatoire entre 0 et 1
console.log(Math.random(0, 10)); // Un nombre aléatoire entre 0 et 10
console.log(Math.random(5, 15)); // Un nombre aléatoire entre 5 et 15
